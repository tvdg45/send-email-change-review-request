<?php
	...
	$message .= "<div style=\"text-align: left\">\r\n";
        $message .= "<p>\r\n";
        $message .= $name . ", \r\n";
        $message .= "you are trying to edit the following review.<br />\r\n";
        $message .= "</p>\r\n";
        $message .= "</div>\r\n";
	$message .= "<div style=\"text-align: left\">\r\n";
        $message .= "<p>\r\n";
	...
	$message .= "<div style=\"text-align: left\">\r\n";
        ...
        $message .= "</div>\r\n";
        $message .= "<div style=\"text-align: left\">\r\n";
        $message .= "<p><a href='" . $domain . "/product-reviews.html?code=" . $security_code . "&review=" . $row_id . "&product=" . $item_id . "&sort=Low%20to%20high&perpage=10&page=1&enablereviewediting=Enable&search=Search'>Edit review</a></p>\r\n";
        $message .= "</div>\r\n";
        $message .= "<div style=\"text-align: left\">\r\n";
        $message .= "<p>If you did not intend to edit this review disregard this email.</p>\r\n";
        $message .= "</div>\r\n";
        ...
        // Mail it
        mail($email, ($name . ', you are trying to edit your review.'), $message, implode("\r\n", $headers));
